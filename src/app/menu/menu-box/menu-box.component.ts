...
@Component({
  ...
  template:`
      ...
      <a [routerLink]="['/main/menuGroup']" routerLinkActive="active" (click)="layout.close"class="secondary-content"><i class="material-icons">mode_edit</i></a><a><i class="material-icons">ic_icon</i></a></li>
        </div>
          `
})
